...
class LivraisonController extends AbstractController
{
    ...
    #[Route('/{id}/new', name: 'app_livraison_new', methods: ['GET', 'POST'])]
    public function new(Request $request,Commande $commande, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $livraison->setFacture($commande->getProduits() . " total:" . $commande->getPrix() . "DNT");
